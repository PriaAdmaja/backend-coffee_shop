...
const getHistory = (params, query) => {
    return new Promise((resolve, reject) => {
        let sql = `select distinct on (c.transaction_id) t.id, t.promos_id, t.created_at, p2."method" as "payment", p."name", p.pict_url, s2.status , t.created_at, t.notes, d."method", t.grand_total, s."size", c.quantity  from "transaction" t 
