...
const getHistory = (params, query) => {
    return new Promise((resolve, reject) => {
        let sql = `select t.id, t.promos_id, p2."method" as "payment", p."name" , s2.status , t.created_at, t.notes, d."method", t.grand_total, s."size", c.quantity  from "transaction" t 
